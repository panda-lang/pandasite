...
Prism.languages.insertBefore('panda', 'class-name', {
  ...
  'namespace': {
    pattern: RegExp(
      /(\b(?:exports|import(?:\s+static)?|open|opens|package|provides|requires|to|transitive|uses|with)\s+)(?!<keyword>)[a-z]\w*(?:\.[a-z]\w*)*\.?/
